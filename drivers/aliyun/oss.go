...
func ListObjects(aliyunOSSConfig *utils.AliyunOSSConfig, metaKey string) (map[string]interface{}, error) {
...
func PutObjectFromFile(aliyunOSSConfig *utils.AliyunOSSConfig, objectKey, filePath string, metasMap map[string]interface{}) error {
	client, err := oss.New(aliyunOSSConfig.Endpoint, aliyunOSSConfig.AccessKeyID, aliyunOSSConfig.AccessKeySecret)
	if err != nil {
		HandleError(err)
		return err
...
func DeleteObject(aliyunOSSConfig *utils.AliyunOSSConfig, objectKey string) error {
	client, err := oss.New(aliyunOSSConfig.Endpoint, aliyunOSSConfig.AccessKeyID, aliyunOSSConfig.AccessKeySecret)
	if err != nil {
		HandleError(err)
		return err
